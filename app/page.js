...
export default function Home() {
  ...
  useGSAP(() => {
    ...
    // Name animation
    tl.to('.name', { opacity: 1, y: "-50%", duration: 5 })
      .to('.name', { opacity: 0, y: "-100%", duration: 5 });

    // Image rows animation
    tl.to('.image-row1', {
      x: isMobile ? '-550%' : '-260%',
      duration: 20
    }, 'imageRows');
    ...
    tl.to('.name2', { opacity: 1, y: "-50%", duration: 5 })
      .to('.name2', { opacity: 0, y: "-100%", duration: 5 });
    ...
    tl.to('.cities-list', {
      ...
      duration: 20,
      transform: isMobile ?
        "matrix3d(0.5, 0, 0, 0, 0, 0.5, 0, 0, 0, 0, 0.5, 0, 0, -500, 0, 0.1)" :
        "matrix3d(0.3, 0, 0, 0, 0, 0.3, 0, 0, 0, 0, 0.3, 0, 0, -1487, 0, 0.1)",
    });

    // Scroll down wrapper fade out
    tl.to('.scroll-down-wrapper', { opacity: 0, duration: 5 });
